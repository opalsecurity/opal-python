    ...
    def make_instance(self, include_optional) -> Resource:
        ...
        if include_optional:
            return Resource(
                ...
                remote_resource_id = '318038399',
                remote_resource_name = 'repo-name',
                ...
                parent_resource_id = '06851574-e50d-40ca-8c78-f72ae6ab4305',
  ...
  "okta_directory_role":
    {
      ...
      "role_type": "SUPER_ADMIN",
                ...
                remote_info = opal_security.models.resource_remote_info.ResourceRemoteInfo(
                    ...
                    oracle_fusion_role = opal_security.models.resource_remote_info_oracle_fusion_role.ResourceRemoteInfo_oracle_fusion_role(
                        role_id = '123e4567-e89b-12d3-a456-426614174000', ), ),
                ancestor_resource_ids = [f454d283-ca67-4a8a-bdbb-df212eca5345, f454d283-ca67-4a8a-bdbb-df212eca5346],
                descendant_resource_ids = [f454d283-ca67-4a8a-bdbb-df212eca5347, f454d283-ca67-4a8a-bdbb-df212eca5348],

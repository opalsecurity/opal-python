...
class CampaignItemReview(BaseModel):
    ...
    resolution_message: Optional[StrictStr] = Field(default=None, description="Preset assignment summary when a manager/owner chain was resolved or substituted. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["campaign_item_review_id", "campaign_item_id", "reviewer_user_id", "assignment_source", "decision", "note", "updated_access_level_remote_id", "decided_at", "resolution_message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resolution_message": obj.get("resolution_message")
        })

...
class OpalAccessResultEdge(BaseModel):
    """
    A single ACCESS result edge containing the matched access grant and its pagination cursor.
    """ # noqa: E501
    node: OpalAccessResultNode
    cursor: StrictStr = Field(description="Opaque cursor for this grant, used for pagination.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "node": OpalAccessResultNode.from_dict(obj["node"]) if obj.get("node") is not None else None,

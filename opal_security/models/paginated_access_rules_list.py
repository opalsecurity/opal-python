...
class PaginatedAccessRulesList(BaseModel):
    """
    ...
    previous: Optional[StrictStr] = Field(default=None, description="The cursor used to retrieve the previous page of results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [AccessRule.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })

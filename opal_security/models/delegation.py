...
class Delegation(BaseModel):
    ...
    created_at: datetime = Field(description="The creation time of the delegation.")
    updated_at: datetime = Field(description="The last updated time of the delegation.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "delegator_user_id", "delegate_user_id", "start_time", "end_time", "reason", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "delegator_user_id": obj.get("delegator_user_id"),
            "delegate_user_id": obj.get("delegate_user_id"),

...
class PaginatedDelegationsList(BaseModel):
    """
    A list of delegations for your organization.
    """ # noqa: E501
    results: Optional[List[Delegation]] = Field(default=None, description="The delegations in the result set.")
    ...
    __properties: ClassVar[List[str]] = ["results", "next", "previous", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Delegation.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "next": obj.get("next"),

...
class GroupRemoteInfoGithubEnterpriseTeam(BaseModel):
    """
    Remote info for GitHub Enterprise team.
    """ # noqa: E501
    team_slug: StrictStr = Field(description="The slug of the GitHub Enterprise team.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["team_slug"]

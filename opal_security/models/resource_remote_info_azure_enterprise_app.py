...
class ResourceRemoteInfoAzureEnterpriseApp(BaseModel):
    """
    Remote info for Azure Enterprise App.
    """ # noqa: E501
    resource_id: StrictStr = Field(description="The remote application identifier (service principal or application object ID).")

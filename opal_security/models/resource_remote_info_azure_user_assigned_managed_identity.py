...
class ResourceRemoteInfoAzureUserAssignedManagedIdentity(BaseModel):
    """
    Remote info for Azure user assigned managed identity.
    """ # noqa: E501
    resource_id: StrictStr = Field(description="The ARM resource ID of the user assigned managed identity.")

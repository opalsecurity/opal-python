...
class OpalAccessPathDetail(BaseModel):
    """
    ...
    expiration: Optional[datetime] = Field(default=None, description="This path's expiration, if any.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["path", "expiration"]

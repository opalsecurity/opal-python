...
class EntityDescriptionFilter(BaseModel):
    """
    ...
    """ # noqa: E501
    string: StrictStr = Field(description="The substring to match against the entity description.")
    var_not: Optional[StrictBool] = Field(default=None, description="Invert the match — return resources/groups whose description does NOT contain the substring.", alias="not")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["string", "not"]

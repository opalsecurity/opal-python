...
class OpalQueryResultEdge(BaseModel):
    """
    A single result edge from an OpalQuery, containing the matched entity and its pagination cursor.
    """ # noqa: E501
    node: OpalQueryResultNode
    cursor: StrictStr = Field(description="Opaque cursor for this entity, used for pagination.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "node": OpalQueryResultNode.from_dict(obj["node"]) if obj.get("node") is not None else None,

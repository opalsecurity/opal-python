...
class AddBundleResourceRequest(BaseModel):
    """
    AddBundleResourceRequest
    """ # noqa: E501
    resource_id: StrictStr = Field(description="The ID of the resource to add.")
    resource_name: Optional[StrictStr] = Field(default=None, description="The name of the resource to add.")
    ...
    __properties: ClassVar[List[str]] = ["resource_id", "resource_name", "access_level_remote_id", "access_level_name"]

...
class BundleResource(BaseModel):
    ...
    resource_name: Optional[StrictStr] = Field(default=None, description="The name of the resource within a bundle.")
    ...
    __properties: ClassVar[List[str]] = ["bundle_id", "resource_id", "resource_name", "access_level_name", "access_level_remote_id"]

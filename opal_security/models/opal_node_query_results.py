...
class OpalNodeQueryResults(BaseModel):
    """
    Paginated results of a NODE-type OpalQuery — one edge per matched entity (user, resource, or group).
    """ # noqa: E501
    type: StrictStr
    edges: List[OpalQueryResultEdge] = Field(description="List of matched entities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "edges": [OpalQueryResultEdge.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None,

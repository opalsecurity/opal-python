...
class OpalNodeQuery(BaseModel):
    ...
    after: Optional[StrictStr] = Field(default=None, description="Cursor from a previous response to fetch the next page of results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "query": OpalNodeQueryBody.from_dict(obj["query"]) if obj.get("query") is not None else None,
            "first": obj.get("first"),
            "after": obj.get("after")
        })

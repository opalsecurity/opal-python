...
class CampaignItemUnassignedPresetMessage(BaseModel):
    """
    ...
    message: StrictStr = Field(description="Human-readable explanation of why no reviewer was assigned.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["campaign_item_id", "assignment_source", "message"]

...
class BundleGroup(BaseModel):
    ...
    group_name: Optional[StrictStr] = Field(default=None, description="The name of the group within a bundle.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["bundle_id", "group_id", "group_name"]

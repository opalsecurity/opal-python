...
class OpalAccessQuery(BaseModel):
    """
    ...
    after: Optional[StrictStr] = Field(default=None, description="Opaque cursor from a previous ACCESS response to fetch the next page of results.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "query", "first", "after"]

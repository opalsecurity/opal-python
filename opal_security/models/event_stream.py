...
class EventStream(BaseModel):
    ...
    """ # noqa: E501
    event_stream_id: UUID = Field(description="The ID of the event stream.")
    connection: EventStreamConnection
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["event_stream_id", "connection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event_stream_id": obj.get("event_stream_id"),
            "connection": EventStreamConnection.from_dict(obj["connection"]) if obj.get("connection") is not None else None
        })

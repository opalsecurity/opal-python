...
class RequestsApi:
    ...
    def create_request_comment(
        ...
        _param = self._create_request_comment_serialize(
            id=id,
            create_request_comment_request=create_request_comment_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_request_comment_serialize(
        self,
        id,
        create_request_comment_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_request_comment_request is not None:
            _body_params = create_request_comment_request
    ...
    def deny_request(
        ...
        _param = self._deny_request_serialize(
            id=id,
            deny_request_request=deny_request_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _deny_request_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if deny_request_request is not None:
            _body_params = deny_request_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/requests/{id}/deny',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_request_comments(
        ...
        _param = self._get_request_comments_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def get_request_comments_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RequestCommentList]:
        """get_request_comments
    ...
    def _get_request_comments_serialize(
        self,
        id,
        _request_auth,
        _content_type,

...
class GroupsApi:
    ...
    def update_group_user(
        ...
        _param = self._update_group_user_serialize(
            group_id=group_id,
            user_id=user_id,
            update_group_user_request=update_group_user_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_group_user_serialize(
        self,
        group_id,
        user_id,
        ...
        # process the form parameters
        # process the body parameter
        if update_group_user_request is not None:
            _body_params = update_group_user_request

...
class AccessRulesApi:
    ...
    def _get_access_rule_serialize(
        ...
        if access_rule_id is not None:
            _path_params['access_rule_id'] = access_rule_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/access-rules/{access_rule_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_access_rules(
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page. Default is 200.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_access_rules_serialize(
            cursor=cursor,
            page_size=page_size,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_access_rules_with_http_info(
        self,
        cursor: Annotated[Optional[StrictStr], Field(description="The pagination cursor value.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page. Default is 200.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedAccessRulesList]:
        """get_access_rules
    ...
    @validate_call
    def get_access_rules_without_preload_content(
        self,
        cursor: Annotated[Optional[StrictStr], Field(description="The pagination cursor value.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page. Default is 200.")] = None,
        _request_timeout: Union[
    ...
    def _get_access_rules_serialize(
        self,
        cursor,
        page_size,
        _request_auth,

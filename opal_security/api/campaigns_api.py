...
class CampaignsApi:
    ...
    @validate_call
    def update_campaign_item_reviewers(
        self,
        campaign_id: Annotated[UUID, Field(description="The ID of the campaign.")],
        update_campaign_item_reviewers_info: UpdateCampaignItemReviewersInfo,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Atomically assigns and unassigns reviewers on campaign items in one request. All `campaign_item_id`s must belong to `{campaign_id}`. Existing assign pairs are ignored; missing unassign pairs are skipped. Completed reviews (`decided_at` set) are never removed. Requires settings-edit permission. Returns 400 if the campaign has ended. 

        :param campaign_id: The ID of the campaign. (required)
        :type campaign_id: UUID
        :param update_campaign_item_reviewers_info: (required)
        :type update_campaign_item_reviewers_info: UpdateCampaignItemReviewersInfo
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_campaign_item_reviewers_serialize(
            campaign_id=campaign_id,
            update_campaign_item_reviewers_info=update_campaign_item_reviewers_info,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateCampaignItemReviewersResult",
            '400': None,
            '403': None,
            '404': None,
        }
    ...
    @validate_call
    def update_campaign_item_reviewers_with_http_info(
        self,
        campaign_id: Annotated[UUID, Field(description="The ID of the campaign.")],
        update_campaign_item_reviewers_info: UpdateCampaignItemReviewersInfo,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateCampaignItemReviewersResult]:
        """Update campaign item reviewers
    ...
    @validate_call
    def update_campaign_item_reviewers_without_preload_content(
        self,
        campaign_id: Annotated[UUID, Field(description="The ID of the campaign.")],
        update_campaign_item_reviewers_info: UpdateCampaignItemReviewersInfo,
        _request_timeout: Union[
    ...
    def _update_campaign_item_reviewers_serialize(
        self,
        campaign_id,
        update_campaign_item_reviewers_info,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_campaign_item_reviewers_info is not None:
            _body_params = update_campaign_item_reviewers_info
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/campaigns/{campaign_id}/item-reviewers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

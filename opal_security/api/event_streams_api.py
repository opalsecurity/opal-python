...
class EventStreamsApi:
    ...
    def create_event_stream(
        ...
        :param create_event_stream_info: (required)
        :type create_event_stream_info: CreateEventStreamInfo
        ...
        _param = self._create_event_stream_serialize(
            create_event_stream_info=create_event_stream_info,
    ...
    def _create_event_stream_serialize(
        ...
        if create_event_stream_info is not None:
            _body_params = create_event_stream_info
    ...
    def delete_event_stream(
        self,
        event_stream_id: Annotated[UUID, Field(description="The ID of the event stream.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param event_stream_id: The ID of the event stream. (required)
        :type event_stream_id: UUID
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _delete_event_stream_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/event-streams/{event_stream_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_event_streams(
        ...
        _param = self._get_event_streams_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_event_streams_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_event_streams_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_event_streams_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def update_event_stream(
        ...
        :param event_stream_id: The ID of the event stream. (required)
        :type event_stream_id: UUID
        :param update_event_stream_info: (required)
        :type update_event_stream_info: UpdateEventStreamInfo
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_event_stream_serialize(
            event_stream_id=event_stream_id,
            update_event_stream_info=update_event_stream_info,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_event_stream_with_http_info(
        self,
        event_stream_id: Annotated[UUID, Field(description="The ID of the event stream.")],
        update_event_stream_info: UpdateEventStreamInfo,
        _request_timeout: Union[
    ...
    @validate_call
    def update_event_stream_without_preload_content(
        self,
        event_stream_id: Annotated[UUID, Field(description="The ID of the event stream.")],
        update_event_stream_info: UpdateEventStreamInfo,
        _request_timeout: Union[
    ...
    def _update_event_stream_serialize(
        self,
        event_stream_id,
        update_event_stream_info,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_event_stream_info is not None:
            _body_params = update_event_stream_info

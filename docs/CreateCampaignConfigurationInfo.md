...
------------ | ------------- | ------------- | -------------
**query** | [**OpalAccessPathQueryBody**](OpalAccessPathQueryBody.md) | Access-path query defining the scope of access to review. Required. Uses the same principalFilter / entitlementFilter shape as ACCESS OpalQuery. Must include at least one of principalFilter or entitlementFilter.  Campaign scope only supports direct access edges: &#x60;edgeFilter.directOnly&#x60; defaults to &#x60;true&#x60;, is always stored as &#x60;true&#x60;, and passing &#x60;false&#x60; returns 400.  | 

...
[**update_campaign_item_reviewers**](CampaignsApi.md#update_campaign_item_reviewers) | **POST** /campaigns/{campaign_id}/item-reviewers | Update campaign item reviewers
...
# **update_campaign_item_reviewers**
> UpdateCampaignItemReviewersResult update_campaign_item_reviewers(campaign_id, update_campaign_item_reviewers_info)

Update campaign item reviewers
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    api_instance = opal_security.CampaignsApi(api_client)
    campaign_id = UUID('f454d283-ca87-4a8a-bdbb-df212eca5353') # UUID | The ID of the campaign.
    update_campaign_item_reviewers_info = opal_security.UpdateCampaignItemReviewersInfo() # UpdateCampaignItemReviewersInfo | 

    try:
        # Update campaign item reviewers
        api_response = api_instance.update_campaign_item_reviewers(campaign_id, update_campaign_item_reviewers_info)
        print("The response of CampaignsApi->update_campaign_item_reviewers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignsApi->update_campaign_item_reviewers: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_id** | **UUID**| The ID of the campaign. | 
 **update_campaign_item_reviewers_info** | [**UpdateCampaignItemReviewersInfo**](UpdateCampaignItemReviewersInfo.md)|  | 

### Return type

[**UpdateCampaignItemReviewersResult**](UpdateCampaignItemReviewersResult.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Reviews for all referenced items after the update. |  -  |
**400** | Invalid input, items not in this campaign, campaign ended, or self-review violation.  |  -  |
**403** | Missing settings-edit permission. |  -  |
**404** | Campaign or one or more campaign items not found. |  -  |

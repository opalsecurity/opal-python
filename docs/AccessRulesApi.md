...
[**get_access_rules**](AccessRulesApi.md#get_access_rules) | **GET** /access-rules | 
...
# **get_access_rules**
> PaginatedAccessRulesList get_access_rules(cursor=cursor, page_size=page_size)
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_access_rules(cursor=cursor, page_size=page_size)
        print("The response of AccessRulesApi->get_access_rules:\n")
        pprint(api_response)
    except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | One page of access rules for your organization. |  -  |

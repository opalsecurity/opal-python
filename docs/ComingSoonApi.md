...
------------- | ------------- | -------------
[**add_bundle_group**](ComingSoonApi.md#add_bundle_group) | **POST** /experimental/bundles/{bundle_id}/groups | 
[**add_bundle_resource**](ComingSoonApi.md#add_bundle_resource) | **POST** /experimental/bundles/{bundle_id}/resources | 
...
[**get_bundle_groups**](ComingSoonApi.md#get_bundle_groups) | **GET** /experimental/bundles/{bundle_id}/groups | 
[**get_bundle_resources**](ComingSoonApi.md#get_bundle_resources) | **GET** /experimental/bundles/{bundle_id}/resources | 
[**get_bundle_visibility**](ComingSoonApi.md#get_bundle_visibility) | **GET** /experimental/bundles/{bundle_id}/visibility | 
[**get_bundles**](ComingSoonApi.md#get_bundles) | **GET** /experimental/bundles | 
[**remove_bundle_group**](ComingSoonApi.md#remove_bundle_group) | **DELETE** /experimental/bundles/{bundle_id}/groups/{group_id} | 
[**remove_bundle_resource**](ComingSoonApi.md#remove_bundle_resource) | **DELETE** /experimental/bundles/{bundle_id}/resources/{resource_id} | 
[**update_bundle**](ComingSoonApi.md#update_bundle) | **PUT** /experimental/bundles/{bundle_id} | 
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComingSoonApi->add_bundle_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ComingSoonApi->add_bundle_group: %s\n" % e)
```
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComingSoonApi->add_bundle_resource:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ComingSoonApi->add_bundle_resource: %s\n" % e)
```
...
# **get_bundle_groups**
> PaginatedBundleGroupList get_bundle_groups(bundle_id, page_size=page_size, cursor=cursor, contains=contains)
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_bundle_groups(bundle_id, page_size=page_size, cursor=cursor, contains=contains)
        print("The response of ComingSoonApi->get_bundle_groups:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ComingSoonApi->get_bundle_groups: %s\n" % e)
```
...
> PaginatedBundleResourceList get_bundle_resources(bundle_id, page_size=page_size, cursor=cursor, contains=contains)
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_bundle_resources(bundle_id, page_size=page_size, cursor=cursor, contains=contains)
        print("The response of ComingSoonApi->get_bundle_resources:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ComingSoonApi->get_bundle_resources: %s\n" % e)
```
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComingSoonApi->get_bundle_visibility:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ComingSoonApi->get_bundle_visibility: %s\n" % e)
```
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ComingSoonApi->remove_bundle_group: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | Group was successfully removed from the bundle. |  -  |
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ComingSoonApi->remove_bundle_resource: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | Resource was successfully removed from the bundle. |  -  |
...
with opal_security.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComingSoonApi->update_bundle:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ComingSoonApi->update_bundle: %s\n" % e)
```

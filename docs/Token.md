...
------------ | ------------- | ------------- | -------------
**token_id** | **UUID** | The ID of the API token. | 
**created_at** | **datetime** | The date and time the token was created. | 
**token_label** | **str** | A human-readable label for the token. | 
**creator_user_id** | **UUID** | The ID of the user who created the token. | 
**user_id** | **UUID** | The ID of the user the token authenticates as. | 

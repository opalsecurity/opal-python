...
class Group(ModelNormal):
    ...
    def _from_openapi_data(cls, group_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            owner_team_id (str): The ID of the owning team of the group.. [optional]  # noqa: E501
            group_function (GroupFunctionEnum): [optional]  # noqa: E501
            group_type (GroupTypeEnum): [optional]  # noqa: E501
            visibility (VisibilityEnum): [optional]  # noqa: E501
            max_duration (int): The maximum duration access to the group can be requested for (in minutes).. [optional]  # noqa: E501

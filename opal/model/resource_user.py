...
class ResourceUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_id, user_id, access_level, full_name, email, expiration_date, *args, **kwargs):  # noqa: E501
        """ResourceUser - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_id, user_id, access_level, full_name, email, expiration_date, *args, **kwargs):  # noqa: E501
        """ResourceUser - a model defined in OpenAPI

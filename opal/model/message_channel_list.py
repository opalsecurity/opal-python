...
class MessageChannelList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'channels': ([MessageChannel],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, channels, *args, **kwargs):  # noqa: E501
        """MessageChannelList - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, channels, *args, **kwargs):  # noqa: E501
        """MessageChannelList - a model defined in OpenAPI

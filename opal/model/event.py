...
class Event(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_id, actor_user_id, event_type, created_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_id, actor_user_id, event_type, created_at, *args, **kwargs):  # noqa: E501
        """Event - a model defined in OpenAPI

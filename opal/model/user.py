...
class User(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, email, full_name, team_id, position, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, email, full_name, team_id, position, *args, **kwargs):  # noqa: E501
        """User - a model defined in OpenAPI

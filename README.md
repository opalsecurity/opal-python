...
*ComingSoonApi* | [**add_bundle_group**](docs/ComingSoonApi.md#add_bundle_group) | **POST** /experimental/bundles/{bundle_id}/groups | 
*ComingSoonApi* | [**add_bundle_resource**](docs/ComingSoonApi.md#add_bundle_resource) | **POST** /experimental/bundles/{bundle_id}/resources | 
...
*ComingSoonApi* | [**get_bundle_groups**](docs/ComingSoonApi.md#get_bundle_groups) | **GET** /experimental/bundles/{bundle_id}/groups | 
*ComingSoonApi* | [**get_bundle_resources**](docs/ComingSoonApi.md#get_bundle_resources) | **GET** /experimental/bundles/{bundle_id}/resources | 
*ComingSoonApi* | [**get_bundle_visibility**](docs/ComingSoonApi.md#get_bundle_visibility) | **GET** /experimental/bundles/{bundle_id}/visibility | 
*ComingSoonApi* | [**get_bundles**](docs/ComingSoonApi.md#get_bundles) | **GET** /experimental/bundles | 
*ComingSoonApi* | [**remove_bundle_group**](docs/ComingSoonApi.md#remove_bundle_group) | **DELETE** /experimental/bundles/{bundle_id}/groups/{group_id} | 
*ComingSoonApi* | [**remove_bundle_resource**](docs/ComingSoonApi.md#remove_bundle_resource) | **DELETE** /experimental/bundles/{bundle_id}/resources/{resource_id} | 
*ComingSoonApi* | [**update_bundle**](docs/ComingSoonApi.md#update_bundle) | **PUT** /experimental/bundles/{bundle_id} | 
